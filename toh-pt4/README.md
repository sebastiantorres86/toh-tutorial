...
En un [tutorial posterior sobre HTTP](), aprenderá que los métodos de Angular [`HttpClient`](https://angular.io/api/common/http/HttpClient) devuelven `Observable`s RxJS. En este tutorial, simulará la obtención de datos del servidor con la función RxJS `of()`.
